...
class VideoGridView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (participantCount == 1) {
      return _buildVideoTile(participants[0], isFullScreen: true);
    }
    ...
    if (participantCount == 3) {
      return Column(
        children: [
          Expanded(
            flex: 2,
            child: _buildVideoTile(participants[0]),
          ),
          Expanded(
            child: Row(
              children: [
                Expanded(child: _buildVideoTile(participants[1])),
                Expanded(child: _buildVideoTile(participants[2])),
              ],
            ),
          ),
        ],
        ...
        children: [
          ...
          Expanded(
            child: Row(
              children: [
                Expanded(child: _buildVideoTile(participants[2])),
                Expanded(child: _buildVideoTile(participants[3])),
              ],
            ),
          ),
        ],
  ...
  Widget _buildVideoTile(VideoParticipant participant, {bool isFullScreen = false}) {
