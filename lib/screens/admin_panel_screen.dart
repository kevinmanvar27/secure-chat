  ...
  Future<void> _toggleAds(bool value) async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(value ? 'Ads Enabled' : 'Ads Disabled'),
          backgroundColor: value ? AppTheme.getSuccessColor(context) : AppTheme.getErrorColor(context),
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [AppTheme.getPrimaryColor(context), AppTheme.getSecondaryColor(context)],
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: AppTheme.getOnPrimaryColor(context).withOpacity(0.2),
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: Icon(
                            Icons.ads_click,
                            color: _adsEnabled ? AppTheme.getSuccessColor(context) : AppTheme.getErrorColor(context),
                            size: 24,
                          ),
                        ),
                        const SizedBox(width: 16),
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                _adsEnabled ? 'Ads are showing' : 'Ads are hidden',
                                style: TextStyle(
                                  fontSize: 14,
                        ...
                        if (_isLoading)
                          ...
                          Switch(
                            ...
                            inactiveThumbColor: AppTheme.getErrorColor(context),
                          ),
                      ],
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'This setting is synced with Firebase. Changes will apply to all users immediately.',
                              style: TextStyle(
                                fontSize: 12,
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            color: _bannerEnabled 
                                ...
                                : AppTheme.getDisabledColor(context).withOpacity(0.1),
                            borderRadius: BorderRadius.circular(10),
                          ),
                          child: Icon(
                            Icons.view_carousel,
                            color: _bannerEnabled ? AppTheme.getPrimaryColor(context) : AppTheme.getDisabledColor(context),
                            size: 24,
                          ),
                        ),
                        const SizedBox(width: 16),
                        ...
                        if (_isBannerLoading)
                          ...
                          Switch(
                            ...
                            inactiveThumbColor: AppTheme.getDisabledColor(context),
                          ),
                      ],
                    ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(
                    color: AppTheme.getWarningColor(context).withOpacity(0.3),
                  ),
                ),
                child: Row(
                  children: [
