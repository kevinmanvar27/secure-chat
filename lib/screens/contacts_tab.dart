  ...
  void _showSnackBar(String message) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        ...
        backgroundColor: AppTheme.getSnackBarBackground(context),
    ...
    return ListView(
      ...
      children: [
        ...
        if (appUserContacts.isNotEmpty) ...[
          _buildSectionHeader('On SecureChat', Icons.check_circle, AppTheme.getSuccessColor(context)),
        ...
        if (nonAppUserContacts.isNotEmpty) ...[
          _buildSectionHeader('Invite to SecureChat', Icons.person_add, AppTheme.getWarningColor(context)),
          ...
          children: [
            ...
            CircleAvatar(
              ...
              backgroundColor: isAppUser 
                  ? AppTheme.getSuccessColor(context).withOpacity(0.2) 
